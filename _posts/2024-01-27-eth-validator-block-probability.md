...
1. **Total Eligible ETH (N):** The total amount of eligible ETH in the network. As of 2025-09-03 10:15, it's approximately 35710771 ETH.
...
- **Probability of not proposing a block in one slot:** $$ 1 - \frac{32}{35710771} $$
- **One Hour (300 slots):** $$ \left( 1 - \frac{32}{35710771} \right)^{300} $$
- **One Day (7,200 slots):** $$ \left( 1 - \frac{32}{35710771} \right)^{7200} $$
- **One Week (50,400 slots):** $$ \left( 1 - \frac{32}{35710771} \right)^{50400} $$
- **One Month (approx. 30 days, 216,000 slots):** $$ \left( 1 - \frac{32}{35710771} \right)^{216000} $$
...
- **Probability of not proposing a block in one slot:** $$ 1 - \frac{3200}{35710771} $$
- **One Hour (300 slots):** $$ \left( 1 - \frac{3200}{35710771} \right)^{300} $$
- **One Day (7,200 slots):** $$ \left( 1 - \frac{3200}{35710771} \right)^{7200} $$
- **One Week (50,400 slots):** $$ \left( 1 - \frac{3200}{35710771} \right)^{50400} $$
- **One Month (approx. 30 days, 216,000 slots):** $$ \left( 1 - \frac{3200}{35710771} \right)^{216000} $$
