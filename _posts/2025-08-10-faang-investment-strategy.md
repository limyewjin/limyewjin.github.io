...
{% include figure.liquid loading="eager" path="assets/img/ScreenShot-deedy.png" class="img-fluid rounded z-depth-1" width="50%" zoomable=true %}
...
{% include figure.liquid loading="eager" path="assets/img/ScreenShot-levels.png" class="img-fluid rounded z-depth-1" width="50%" zoomable=true %}
