...
{% include audio.liquid path="assets/audio/hacker_news_podcast_jul_27_23.mp3" controls=true %}
...
{% include audio.liquid path="assets/audio/nytimes-podcast-290723.mp3" controls=true %}
